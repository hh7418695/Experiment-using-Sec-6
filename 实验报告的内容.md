...
本文件参考了《论文Realistic haptic rendering of hyper-elastic material via measurement-based FEM model identification and real-time simulation》的心理物理研究实验方法。用于记录我设计的心理物理实验设计来解决我心中的研究疑惑，包括：
